...
export default function Home() {
  return (
    <main className="grid grid-cols-1 md:grid-cols-2 w-full md:px-28  min-h-screen items-center">
      <section className="relative isolate">
        <h1 className=" text-[60px] uppercase leading-[55px] mb-4">
          My name <br /> is{" "}
        ...
        <div className=" md:mt-10 flex gap-8">
          <span className=" flex gap-2 font-bold italic">
            <Image
              className=" bg-[#1413130D] rounded-full px-1"
